...
const EmployerProfile = require('../backend/src/models/EmployerProfile'); // Required for populate
const Skill = require('../backend/src/models/Skill'); // Required for populate
const { createFlexibleRegex } = require('../backend/src/utils/textUtils');
