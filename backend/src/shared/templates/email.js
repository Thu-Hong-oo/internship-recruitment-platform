    ...
    return {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #16569bff; color: white; padding: 20px; text-align: center;">
            <h1>Xác thực email của bạn</h1>
          </div>
          <div style="padding: 20px; background-color: #f9f9f9;">
            <p>Xin chào ${
              user.fullName || (user.email ? user.email.split('@')[0] : 'bạn')
            },</p>
            <p>Cảm ơn bạn đã đăng ký tài khoản. Để hoàn tất quá trình đăng ký, vui lòng nhập mã OTP sau:</p>
            <div style="text-align: center; margin: 30px 0;">
              <p style="font-size: 32px; font-weight: bold; color: #16569BFF; letter-spacing: 5px; background-color: #f0f0f0; padding: 20px; border-radius: 10px; display: inline-block;">
                ${otp}
              </p>
            </div>
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 20px; background-color: #f9f9f9;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <p style="font-size: 32px; font-weight: bold; color: #16569BFF; letter-spacing: 5px; background-color: #f0f0f0; padding: 20px; border-radius: 10px; display: inline-block;">${otp}</p>
            </div>
