...
export default function DashboardPage() {
  ...
  const verificationTasks = [
    ...
    { id: 4, text: "Đăng tin tuyển dụng đầu tiên", completed: false, highlight: true },
  ]
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <Avatar className="w-8 h-8">
              <AvatarFallback className="bg-white text-slate-800 text-sm">NM</AvatarFallback>
            </Avatar>
      ...
      <div className="flex">
          ...
          <div className="p-4 border-b">
            <div className="flex items-center gap-3">
              <Avatar className="w-10 h-10">
                <AvatarFallback className="bg-green-100 text-green-600">NM</AvatarFallback>
              </Avatar>
              <div>
            ...
            <div className="mt-3 flex items-center gap-2">
              <span className="text-sm text-slate-600">Tài khoản xác thực:</span>
          ...
          <nav className="p-4">
            <ul className="space-y-2">
              <li>
                <Button
                  variant="ghost"
                  className="w-full justify-start text-slate-700 hover:bg-green-50 hover:text-green-600"
                >
                ...
                <div className="space-y-1">
                  ...
                  <div className="ml-6 space-y-1">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="w-full justify-start text-slate-600 hover:bg-green-50 hover:text-green-600"
                    >
                      Quản lý nhân CV
                      <Badge className="ml-auto bg-blue-500 text-white text-xs">Beta</Badge>
                    </Button>
                    <Button
                      variant="ghost"
                      size="sm"
        ...
        <main className="flex-1 p-6">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white mb-6">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h2 className="text-xl font-bold mb-2">Bạn đang tuyển dụng vị trí:</h2>
                    <h3 className="text-2xl font-bold mb-4">Nhân viên Marketing</h3>
                    <div className="space-y-2">
                      <p className="text-green-100">Đăng tin trên TopCV ngay</p>
                      <p className="text-green-100">Hiệu quả vượt trội - Đáp ứng nhanh chóng</p>
                    </div>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-800 mb-1">
                        <span className="text-green-600">90.000+</span> lượt ứng tuyển vị trí{" "}
                        <span className="text-green-600">Nhân viên marketing</span> mỗi tháng
                      </h3>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-white">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-slate-800 mb-1">
                        Tiếp cận ứng viên tiềm năng trong <span className="text-green-600">130.000+</span> hồ sơ ngành{" "}
                        <span className="text-green-600">Marketing/Truyền thông/Quảng cáo</span>
                      </h3>
                    </div>
                  </div>
                </CardContent>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-slate-800 mb-2">
                      ...
                      <span className="text-green-600">Nhân viên marketing</span> trên TopCV:
                    </h3>
                    <p className="text-slate-600 mb-4">Techcombank, Panasonic Việt Nam, Yamaha Motor Việt Nam,...</p>
        ...
        <aside className="w-80 bg-white shadow-sm min-h-screen p-6">
          ...
          <div className="mb-6">
            <h2 className="text-xl font-bold text-slate-800 mb-2">
              Xin chào, <span className="text-green-600">Nướng Mực</span>
            </h2>
            <p className="text-slate-600 text-sm">
              Hãy thực hiện các bước sau để gia tăng tính bảo mật cho tài khoản của bạn và nhận ngay{" "}
              <span className="text-green-600 font-semibold">+8 Top Point</span> để đổi quà khủng tin tuyển dụng đầu
              tiên trong:
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              <h3 className="font-semibold text-slate-800">Xác thực thông tin</h3>
            ...
            <div className="space-y-3">
              {verificationTasks.map((task) => (
                <div key={task.id} className="flex items-center gap-3">
                  ...
                  {task.highlight && <Badge className="bg-green-500 text-white text-xs ml-auto">+8 Top Point</Badge>}
